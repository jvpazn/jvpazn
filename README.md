...
| [**Loja de Revendas**]((https://github.com/jvpazn/Loja-de-revendas-em-python)) | Meu primeiro grande projeto, ele simula uma loja de revendar no terminal em python que automaticamente se reestoca. | `Java` `Spring Boot` `SQL` |
<br>
